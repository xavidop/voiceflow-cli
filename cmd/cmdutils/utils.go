...
func CheckUpdate(output bool) {
	...
	if latestVersion != "" {
		global.Log.Warnf("A new version is available: %s. Please update the tool using your package manager or downloading the latest release from GitHub: https://github.com/xavidop/voiceflow-cli/releases/latest", latestVersion)
	} else {
